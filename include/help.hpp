...
std::string(ansi::BOLD) + "mank config.<config> <value>" + std::string(ansi::RESET) + " >> Change a configuration to another value\n" +
std::string(ansi::BOLD) + "mank config.name <name>" + std::string(ansi::RESET) + " >> Set your name for commits.\n" +
std::string(ansi::BOLD) + "mank config.email <name>" + std::string(ansi::RESET) + " >> Set your email for commits.\n" +
...
std::string(ansi::BOLD) + "mank ci run [job]" + std::string(ansi::RESET) + " >> Run all jobs or a specific one.\n" +
std::string(ansi::BOLD) + "mank ci logs [job] [--all]" + std::string(ansi::RESET) + " >> Show logs of all jobs or a specific one.\n" +
